 ...
 */
public class Sysdata extends SigarCommandBase {

    public boolean displayTimes = true;
    
    public Sysdata(Shell shell) {
        super(shell);
    }
    ...
    public void output(String[] args) throws SigarException {
        ...
        String Vendor = info.getVendor();    //제조사
        String Model = info.getModel();      //제품명+동작속도
    ...
    public static void main(String[] args) throws Exception {
        new Sysdata().processCommand(args);
    }
}